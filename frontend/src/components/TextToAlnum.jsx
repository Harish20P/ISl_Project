...
const TextToAlnum = () => {
  ...
  return (
    <div>
      <Header />
      <h1 className="text-title">Text To Alphanumeric Converter</h1>
      <div className="text-to-alnum-container">
        <div className="text-to-alnum-content">
      ...
      <form onSubmit={handleSubmit} className="text-input-form">
        ...
        />
        <button type="submit" className="submit-button"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-send-arrow-up" viewBox="0 0 16 16">
